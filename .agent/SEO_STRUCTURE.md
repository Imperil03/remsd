...
## Экспериментальная структура v3

Для визуально-SEO прототипа `/v3/` после hero используется другой порядок: категории техники -> ремонт грузовиков по маркам -> типы спецтехники -> ремонт по узлам -> остальные блоки доверия и контактов. Это не меняет текущую главную `/` и не создает новые SEO-страницы.
