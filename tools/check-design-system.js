...
const consumerCssFiles = ["styles.css", "site-chrome.css", "styles-v3.css", "internal-pages.css", "company-page.css", "contact-page.css"];
...
for (const file of ["styles-v3.css", "internal-pages.css", "company-page.css", "contact-page.css"]) {
  const source = fs.readFileSync(path.join(cssDir, file), "utf8");
...
const physicalLayers = /assets\/css\/(?:design-system|styles|site-chrome|styles-v3|internal-pages|company-page|contact-page)\.css/;
