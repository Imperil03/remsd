...
- `.agent/` — проектные инструкции, SEO/content-контекст, claims ledger, текстовые agent-роли и разрешенные project skills.
...
- Главная страница v1 собрана из partials: шапка, hero, компактный блок официального сервиса КАМАЗ/МАЗ/УРАЛ, основной перечень услуг, процесс приема техники, паспорт сервиса, полная галерея базы, сертификаты, FAQ/SEO-блоки, футер.
- Блок официального сервиса работает как proof-сигнал и навигация в брендовые разделы; главный интент главной — ремонт грузовых автомобилей и спецтехники в Сургуте.
...
- На главной добавлены смысловые блоки для SEO и нейроответов: маршрут техники в работу, карта работ ремонтной базы, зона обслуживания, вопросы и ответы, аренда как отдельный сценарий и контактный CTA.
- Блоки доверия, процесса и базы оформлены в стиле `Industrial Editorial`: proof-rail, техническая timeline и service map вместо одинаковых шаблонных карточек.
...
- Основная SEO-структура страниц хранится в `.agent/SEO_STRUCTURE.md`, правила контента — в `.agent/CONTENT_GUIDE.md`, подтвержденные факты — в `.agent/CLAIMS_LEDGER.md`.
