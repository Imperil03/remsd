...
- `assets/img/brands/`, `assets/img/gallery/`, `assets/img/certificates/` — оптимизированные WebP-медиа с remsd.ru.
...
- Блок официального сервиса усилен логотипами КАМАЗ/МАЗ/УРАЛ и вторичной сеткой брендов; ниже услуг добавлены фото ремонтной базы и компактный блок сертификатов.
