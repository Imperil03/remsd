...
- Главная страница собрана из partials: шапка, hero, блок официального сервиса КАМАЗ/МАЗ/УРАЛ, перечень услуг, proof-rail доверия, полная галерея базы, сертификаты, FAQ/SEO-блоки, футер.
