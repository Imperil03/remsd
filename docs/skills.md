...
3. Применить `russian-text-humanization`.
4. Для важных текстов подключить reviewer subagent: он проверяет естественность языка, читабельность, полезность и соблюдение content rules.
